...
//                 {/* Servings Section */}
//                 <div className="space-y-4">
//                     <h3 className="text-lg font-semibold">3. Number of Servings</h3>
//                     <Input
//                         type="number"
//                         min="1"
        ...
        <Card className="w-full max-w-2xl mx-auto">
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-sm text-slate-600">
                        Total weight per container: {totalContainerWeight}g
                    </p>
                </div>
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg space-y-2">
                        ...
                        {totalContainerWeight > 0 && formData.servings && (
                            <div className="mt-4 space-y-1">
                                <p className="text-lg font-semibold">Total Price: ${calculateTotal()}</p>
                                {/* <p className="text-sm text-slate-600">
                                    (For {formData.quantity} container{parseInt(formData.quantity) > 1 ? 's' : ''})
                                </p> */}
                            </div>
                        )}
                    </div>
